...
func (o *PostClusterOK) GetPayload() *models2.ClusterSettings {
	return o.Payload
}
...
func (o *PostClusterBadRequest) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *PostClusterDefault) GetPayload() *models2.Error {
	return o.Payload
}
