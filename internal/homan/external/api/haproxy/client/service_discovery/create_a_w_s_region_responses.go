...
func (o *CreateAWSRegionCreated) GetPayload() *models2.AwsRegion {
	return o.Payload
}
...
func (o *CreateAWSRegionCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.AwsRegion)
...
func (o *CreateAWSRegionBadRequest) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *CreateAWSRegionConflict) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *CreateAWSRegionDefault) GetPayload() *models2.Error {
	return o.Payload
}
