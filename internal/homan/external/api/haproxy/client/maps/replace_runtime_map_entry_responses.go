...
func (o *ReplaceRuntimeMapEntryOK) GetPayload() *models2.MapEntry {
	return o.Payload
}
...
func (o *ReplaceRuntimeMapEntryBadRequest) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *ReplaceRuntimeMapEntryNotFound) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *ReplaceRuntimeMapEntryDefault) GetPayload() *models2.Error {
	return o.Payload
}
