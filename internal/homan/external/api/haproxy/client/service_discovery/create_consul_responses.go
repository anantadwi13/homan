...
func (o *CreateConsulCreated) GetPayload() *models2.Consul {
	return o.Payload
}
...
func (o *CreateConsulBadRequest) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *CreateConsulConflict) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *CreateConsulDefault) GetPayload() *models2.Error {
	return o.Payload
}
