...
func (o *GetServerSwitchingRuleNotFound) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *GetServerSwitchingRuleDefault) GetPayload() *models2.Error {
	return o.Payload
}
...
type GetServerSwitchingRuleOKBody struct {
	...
	// data
	Data *models2.ServerSwitchingRule `json:"data,omitempty"`
}
