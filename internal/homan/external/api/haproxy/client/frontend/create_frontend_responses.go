...
func (o *CreateFrontendCreated) GetPayload() *models2.Frontend {
	return o.Payload
}
...
func (o *CreateFrontendAccepted) GetPayload() *models2.Frontend {
	return o.Payload
}
...
func (o *CreateFrontendBadRequest) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *CreateFrontendConflict) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *CreateFrontendDefault) GetPayload() *models2.Error {
	return o.Payload
}
