...
func (o *CreateSpoeMessageCreated) GetPayload() *models2.SpoeMessage {
	return o.Payload
}
...
func (o *CreateSpoeMessageCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.SpoeMessage)
...
func (o *CreateSpoeMessageBadRequest) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *CreateSpoeMessageConflict) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *CreateSpoeMessageDefault) GetPayload() *models2.Error {
	return o.Payload
}
