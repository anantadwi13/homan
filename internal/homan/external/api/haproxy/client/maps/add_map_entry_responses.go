...
func (o *AddMapEntryCreated) GetPayload() *models2.MapEntry {
	return o.Payload
}
...
func (o *AddMapEntryBadRequest) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *AddMapEntryConflict) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *AddMapEntryDefault) GetPayload() *models2.Error {
	return o.Payload
}
