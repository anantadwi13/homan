...
func (o *GetHTTPRequestRuleNotFound) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *GetHTTPRequestRuleDefault) GetPayload() *models2.Error {
	return o.Payload
}
...
type GetHTTPRequestRuleOKBody struct {
	...
	// data
	Data *models2.HTTPRequestRule `json:"data,omitempty"`
}
