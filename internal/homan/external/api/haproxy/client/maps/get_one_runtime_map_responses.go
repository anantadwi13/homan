...
func (o *GetOneRuntimeMapOK) GetPayload() *models2.Map {
	return o.Payload
}
...
func (o *GetOneRuntimeMapNotFound) GetPayload() *models2.Error {
	return o.Payload
}
...
func (o *GetOneRuntimeMapDefault) GetPayload() *models2.Error {
	return o.Payload
}
